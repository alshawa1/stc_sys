...
def run_afrad_app():
    ...
    while STC_DIR in sys.path:
        sys.path.remove(STC_DIR)
            ...
            try:
                ...
                if filter_options:
                    ...
                    if "أداء الاستهداف" in rep_cat:
                        ...
                        ops_params["is_targeting_report"] = False
                        col_mode, _ = st.columns([3, 1])
                        with col_mode:
                            rep_type = st.radio(
            ...
            try:
                ...
                with st.spinner("⚙️ جاري معالجة البيانات وتطبيق القواعد الحسابية..."):
                    ...
                    if task_id == 1:
                        ...
                        from modules.module6b_rotation import PortfolioRotationModule
                        r = PortfolioRotationModule().run(portfolio, col, sup, target_collectors=tgt_cols, smart_assignment=smart_assign)
                        stats.update(r["stats"])
